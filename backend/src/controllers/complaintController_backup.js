...
export const rateStaff = async (req, res) => {
  try {
    ...
    // ❗ FIX — user.tenantId, not staff.tenantId
...
/* ===========================================================
   ⭐ 2. SUBMIT COMPLAINT (Citizen Only)
=========================================================== */
export const submitComplaint = async (req, res) => {
  try {
    ...
    console.log("♻️ Redis cache cleared → complaint created");
...
export const assignComplaint = async (req, res) => {
  try {
    ...
    console.log("♻️ Cache cleared → complaint assigned");
...
/* ===========================================================
   ⭐ 5. UPDATE COMPLAINT STATUS (Staff / Admin)
=========================================================== */
